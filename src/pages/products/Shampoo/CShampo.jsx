            ...
            <div className="banner-bg-cshampo">
              <div className="banner-cshampo-content">
                ...
                <p className="cshampo-p-1">
                  Let kids be champions with the right shampoo—because strong
                  hair, healthy scalps, and confidence start at an early age.
                </p>
              ...
              <div className="sec-2-cshampoo-inner">
                ...
                <div className="row sec-2-c-shampo-row align-items-center">
                  ...
                  <div className="col-lg-8">
                    <h4 className="sec-2-c-shampo-row-title">
                      Why do parents invest in baby shampoos but overlook proper
                      hair care after age 5?
                    </h4>
                    <p className="sec-2-c-shampo-row-p">
                      As children grow, maintaining healthy, strong, and
                      dandruff-free hair becomes crucial—especially for
                      school-going kids and young athletes exposed to sweat,
                      dirt, and pollution.
                    </p>
                    <p className="sec-2-c-shampo-row-p">
                      Introducing Chanakya Care Shampoo: A pH-balanced,
                      sulfate-free formula designed specifically for kids aged
                      5-15 years. It’s safe, gentle, and packed with natural
                      ingredients to ensure hair remains nourished, strong, and
                      protected during these vital years.
                    </p>
                  </div>
                </div>
                <div className="row sec-2-c-shampo-row">
                  <div className="col-lg-8">
                    ...
                    <p className="sec-2-c-shampo-row-p">
                      Adult shampoos are often too harsh for children’s delicate
                      scalps. They contain sulfates, parabens, and chemicals
                      that strip natural oils, causing dryness and irritation.
                      Chanakya Care Shampoo is specially formulated for kids’
                      softer, more sensitive hair and scalp, offering the
                      gentlest care with natural, effective ingredients.
                    </p>
                  </div>
                  <div className="col-lg-4">
                    <img src={bannerProductimage} alt="" className="w-100" />
          ...
          <div className="container sha-des">
            <div className="sha-des-holder">
              <div className="row align-items-center">
                ...
                <div className="col-lg-6">
                  <h4 className="sec-4-cshampoo-h">
                    Neem Extract for Lice Control
                  </h4>
                  <p className="sec-4-cshampoo-p">
                    Neem extract is a powerful natural remedy for lice
                    prevention and scalp protection, making it an essential
                    ingredient in Chanakya Care Shampoo. Rich in azadirachtin,
                    neem helps eliminate lice by disrupting their reproduction
                    cycle while forming a protective barrier against
                    infestations. Its antibacterial and antifungal properties
                    soothe itchy scalps, cleanse away dead lice and nits, and
                    ensure long-term scalp health.
                  </p>
                </div>
              </div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6">
                  <h4 className="sec-4-cshampoo-h">
                    Why Young Athletes Need a Special Shampoo
                  </h4>
                  <p className="sec-4-cshampoo-p">
                    Young athletes constantly face scalp challenges due to sweat
                    buildup, shared sports gear, and exposure to pollution.
                    Excess sweat can clog pores, leading to dandruff and
                    itching, while wearing helmets and caps increases the risk
                    of lice infestation. Chanakya Care Shampoo is specially
                    designed with Tea Tree Oil, Neem, and Aloe Vera to ensure
