            ...
            <div className="banner-bg-cshampo">
              <div className="banner-cshampo-content">
                ...
                <h3 className="cshampo-title-1">
                  Give Your Child the hair Care <br />
                  They Deserve!{" "}
                </h3>
                ...
                <div className="row sec-2-c-shampo-row align-items-center">
                  ...
                  <div className="col-lg-8">
                    <h4 className="sec-2-c-shampo-row-title">
                      Why do parents invest in baby shampoo but overlook proper
                    ...
                    <p className="sec-2-c-shampo-row-p">
                      ...
                      dirt, and pollution. Introducing Chanakya Care Shampoo: A
                      pH-balanced, sulfate-free formula designed specifically
                      for kids aged 5-15 years. It’s safe, gentle, and packed
                      with natural ingredients to ensure hair remains nourished,
                      strong, and protected during these vital years
                    </p>
                  </div>
                </div>
