          ...
          <div className="container">
            <div className="row">
              <div className="fc-content col-md-6">
                ...
                <p>
                  Charcoal Face Wash cares for your skin, keeping it clean,
                  clear, and fresh! Detoxify your skin with Activated Charcoal
                  Face Wash, designed to deeply cleanse and refresh.
                </p>
              </div>
            </div>
