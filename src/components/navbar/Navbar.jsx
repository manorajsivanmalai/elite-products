            ...
            <header>
                ...
                <div className="nav-mob-2-wrapper d-md-none d-block">
                    <ul className="mob-nav-2-ul">
                        ...
                        <li className="nav-item"><a to="/"  className="nav-link"><FaRegUser/>Account</a></li>
                   
                        <li className="nav-item"><Link to="/cart" className="nav-link"><CgShoppingBag/>{cartItems.length>0 && <span className="dot"></span>}Cart</Link></li>
                    </ul>
                </div>
            </header>
        </>
