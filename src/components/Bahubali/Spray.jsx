...
const Spray = ({ images, title, description, price, oldPrice, addToCart }) => {
      ...
      <div className="row  row-gap-3">
            ...
            <div className="col-lg-2 col-md-2">
              ...
              {images.map((img, index) => (
                <img
                  ...
                  className={`thumbnail ${selectedImage === img ? "active" : ""} w-100`}
        ...
        <div className="product-details col-lg-6 col-12">
          ...
          <button
            ...
            onClick={() =>addToCart({title,price,quantity,image: selectedImage})}
          >
            ADD TO CART
          </button>
        </div>
